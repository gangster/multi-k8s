...
kubectl set image deployments/client-deployment client=deeden/multi-client:$GIT_SHA
kubectl set image deployments/worker-deployment worker=deeden/multi-worker:$GIT_SHA